...
CLUSTERNAME=$(python -c "from uuid import uuid4; print(str(uuid4())).split('-')[0]")-${NUMWORKERS}nodes-${SPARKEXECUTORCORES}cores-${SPARKEXECUTORMEMORYMB}mb-${SPARKNUMBEROFEXECUTORS}-executors-${SPARKDYNAMICALLOCATIONFLAG}
