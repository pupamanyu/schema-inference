...
-- -m cluster -i "gs://schema-inference-sample-data/internal__legs_gameevents/dt=2020-05-15/h=06/batchid=190936cc-84d9-45f9-af54-81de9f460ee2/000000_0" -s true -o schema-inference-out -t schema-inference-out -bq proto_schema4
