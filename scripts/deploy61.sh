...
--properties spark.dynamicAllocation.enabled=true,spark.shuffle.service.enabled=true,spark.executor.cores=5,spark.executor.memory=21g,spark.num.executors=57,spark.driver.memory=110g \
